...
class TowerOfBlocksSolver:
    ...
    def solve(self):
        class BlockState:
            ...
            def find_solution_with_depth_limit(self, depth_limit):
                return self.depth_limited_search(depth_limit)

            def iterative_deepening_search(self):
                depth_limit = 1
                while True:
                    result, final_state = self.depth_limited_search(depth_limit)
        ...
        solution, final_state = state.iterative_deepening_search()
